...
// //    log.w('Data Message $messageType');
// // log.w(message);
...
class ChatWebSocketService {
  ...
  /// 🔥 NEW: Handle bulk_read format
  /// Format: {"type":"bulk_read","message_ids":[178,177],"read_at":"2026-02-13T03:39:17.391Z"}
  void _handleBulkRead(Map<String, dynamic> data) {
    try {
      ...
      if (messageIds is List && messageIds.isNotEmpty) {
        print('📗 [Processing Bulk Read Receipt] ${messageIds.length} messages at $readAt');
