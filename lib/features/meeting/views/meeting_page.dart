...
class _MeetingPageState extends State<MeetingPage> {
  ...
  void _loadInitialTableView() async {
    ...
    Modular.get<TableBloc>().add(LoadTableView(date: dateToUse, time: timeToUse));
  }
  ...
  void _onDateSelected(String dateString) {
    ...
    ReadContext(context).read<ScheduleBloc>().add(LoadSchedules(date: dateString));
              ...
              builder: (context, state) {
                ...
                if (state is ScheduleLoaded) {
                  ...
                  final currentSchedule =
                      _getCurrentSchedule(schedulesWithStatus);
