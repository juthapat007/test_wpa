...
class DeepLinkService {
  ...
  void _handleLink(Uri uri) {
    ...
    final isHttpsResetLink =
        uri.scheme == 'https' && uri.path == '/deeplink-reset-password';
    final isCustomSchemeResetLink =
        uri.scheme == 'wpa' && uri.host == 'reset-password';
    ...
    if (pathSegments.length >= 2 && pathSegments[0] == 'other_profile') {
      ...
      if (delegateId != null) {
        ...
        Modular.to.navigate('/other_profile/$delegateId');
      }
    }
  }
}
